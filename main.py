    ...
    while True:
        ...
        with open("log.txt", "a") as log_file:
            ...
            if menu == "1":
                ...
                log_file.write(
                    "Выращено яблоко с использованием воды и удобрений\n")
            elif menu == "2":
...
if __name__ == "__main__":
    while True:
        if not manager.check_exit():
            print(
                "Прошлая сессия была завершена некорректно. Данные были сохранены не полностью!"
            )
        print("Добро пожаловать в игру Маленький фермер!\n"
              "1. Начать новую игру\n"
